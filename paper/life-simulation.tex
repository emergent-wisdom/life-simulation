...
\item A learner can maintain one connected, revisable account of world history
  ...
  account (Sections~\ref{sec:corpus-model} and~\ref{sec:alignment}).
\end{enumerate}
The first three have specified experiments in the sections cited, and none has
been run. The fourth is the aim the first three serve; no end-to-end test of it
exists yet, and no result supports it. Each predecessor in this section already
