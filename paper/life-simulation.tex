...
decide where it pays. The proposed contribution is to train a process
sensorium across the corpus (Section~\ref{sec:process-sensorium}): a learned
capacity to infer, maintain, and revise explicit numerical accounts of the
processes underlying text and observations. World histories teach how those
processes develop; construction histories teach which distinctions to
introduce and how to repair their representations. The learned capability
would then help construct the next training corpus. Quantification under the
stance is provisional. A conceptual
...
description or a program. Within that stance the paper advances three testable
hypotheses and one research aim.
\begin{enumerate}[nosep]
\item An early process-sensorium test: aligned explicit process histories
