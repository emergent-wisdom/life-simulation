...
observations. World histories teach how those processes develop; construction
...
exists yet, and no result supports it. Each predecessor above already supplies
one or more of the mechanisms these hypotheses combine; the hypotheses concern
what the combination adds under matched comparison, and they fail under the
negative findings listed in Section~\ref{sec:representation-controls}.
